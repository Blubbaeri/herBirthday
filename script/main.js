...
const messages = [
    ...
    "padahal",
    "gw cuma mau bilang",
    "kamu itu mirip kayak uncle muthu tau",
    "tau ga kenapa?",
    "karna cantik ada",
    "karna lucu ada",
    "karna imut ada",
    ...
    "semuanya ada",
    "aww, bjirr lahh",
    "gw ada pantun nih buat lu",
    "buah manggis, buah mengkudu",
    "selamat hari kamis",
    "buat kamu yang senyumannya indah setiap waktu",
    "aww aww awww",
    "Happy Birtday Ucuu's",
    "coba pencet tombol yang ada dibawah"
];
